...
var error =
document.querySelectorAll('.error_next_box');
...
addEventListener(type,listener);
   ...
   type: 수신할 이벤트유형, 대소문자구별
   listener : 지정할 이벤트(envent 인터페이스를 구현할 객체)를 수신할 객체.
              즉 EventListener 인터페이스를 구현하는 객체이거나 javaScript함수 이어야 함.
...
var idPattern = /[a‐zA‐Z0‐9_‐]{5,20}/;
     ...
     } else if(!idPattern.test(id.value)) { //test()찾는문자열 값이 들어있는지 확인
